...
<html lang="en">
  <head>
    ...
    <link rel="alternate stylesheet" type="text/css" title="orange" href="designr-theme-orange.css">
    <link rel="alternate stylesheet" type="text/css" title="pink" href="designr-theme-pink.css">
    <link rel="alternate stylesheet" type="text/css" title="purple" href="designr-theme-purple.css">
    <link rel="alternate stylesheet" type="text/css" title="red" href="designr-theme-red.css">
...
<input type="submit" onclick="switch_style('pink');return false;" name="theme" value="Pink Theme" id="pink">
    ...
    <script>
      // Initialize Firebase
      var config = {
        apiKey: "AIzaSyB7d96qhPCaoNsPxzHeOLh99LIPnKQkCOQ",
        authDomain: "tic-tac-toe-ca33e.firebaseapp.com",
        databaseURL: "https://tic-tac-toe-ca33e.firebaseio.com",
        storageBucket: "tic-tac-toe-ca33e.appspot.com",
        messagingSenderId: "785231830706"
      };
